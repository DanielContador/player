...
public class TocActivity extends BaseActivity {
    ...
    public boolean skipAutoReturn = false;
    ...
    public void Finish_Course() {
        if (skipAutoReturn) { // ← si venía del botón “Otros”, no relances nada
            skipAutoReturn = false; // (la reinicias por si re-entras a Toc)
            return;
        }
        Log.d(">>>", "Finish_Course");
